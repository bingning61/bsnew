...
| `/result_image` | `sensor_msgs/Image` | Debug image with bbox, red bbox-center marker, and blue image-center line |
...
the red point marks the detection-box center used for `/seam_center.x`,
