...
usage() {
    cat <<'EOF'
Usage:
  bash tools/run_tracking_experiment.sh <baseline|opt_kp06|opt_kp065|slow_v016|speed_low|speed_mid|speed_high> [record_seconds]

Examples:
  cd /home/bn/bsnew
  bash tools/run_tracking_experiment.sh baseline 240
  bash tools/run_tracking_experiment.sh opt_kp06 240
  bash tools/run_tracking_experiment.sh opt_kp065 240
  bash tools/run_tracking_experiment.sh slow_v016 240
  bash tools/run_tracking_experiment.sh speed_low
  bash tools/run_tracking_experiment.sh speed_mid
  bash tools/run_tracking_experiment.sh speed_high
