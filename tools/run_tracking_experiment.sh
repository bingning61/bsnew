...
Examples:
  cd /home/bn/bsnew
  bash tools/run_tracking_experiment.sh baseline 210
  bash tools/run_tracking_experiment.sh opt_kp06 210
  bash tools/run_tracking_experiment.sh opt_kp065 210
  bash tools/run_tracking_experiment.sh slow_v016 210
